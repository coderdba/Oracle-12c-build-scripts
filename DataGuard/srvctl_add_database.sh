...
srvctl add database -d DBUNIQUENAME_STBY -o /u01/app/oracle/product/12.1.0.2.RAC -p '+DATA_DG01/DBUNIQUENAME_STBY/spfileDBNAME.ora' -n RL4DB1 -r PHYSICAL_STANDBY -s mount
